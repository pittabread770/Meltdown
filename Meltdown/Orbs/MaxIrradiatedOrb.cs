...
{
    public class MaxIrradiatedOrb : RoR2.Orbs.LightningOrb
    {
        public int stacks;

        public MaxIrradiatedOrb(GameObject _attacker, float _damage, bool _isCrit, Vector3 _origin, TeamIndex _teamIndex, HurtBox _hurtBox, int _stacks)
        {
            attacker = _attacker;
            bouncedObjects = null;
            bouncesRemaining = 0;
