...
namespace Meltdown.Items.Green
{
    public class VolatileThoriumBattery : ItemBase
    {
        ...
        public override string ItemFullDescription => "Gain <style=cIsDamage>5%</style> chance on hit to <color=#7fff00>Irradiate</color> enemies. <color=#7fff00>Irradiated</color> enemies have a <style=cIsDamage>20%</style> chance per tick to deal <style=cIsDamage>200%</style> damage in a <style=cIsDamage>12m</style> <style=cStack>(+4m per stack)</style> radius, applying <color=#7fff00>Irradiated</style>.";
