...
namespace Meltdown.Items.Green
{
    public class VolatileThoriumBattery : ItemBase
    {
        ...
        public override string ItemPickupDesc => "Irradiated enemies explode on death, spreading their irradiated effects. Gain a small chance to irradiate enemies.";
        public override string ItemFullDescription => "Gain <style=cIsDamage>5%</style> chance on hit to <color=#7fff00>irradiate</color> enemies. On death, <color=#7fff00>Irradiated</color> enemies explode for <style=cIsDamage>200%</style> base damage in a <style=cIsDamage>12m</style> <style=cStack>(+4m per stack)</style> radius, applying <style=cIsDamage>all</style> of their <color=#7fff00>Irradiated</color> effects.";
